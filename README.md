...
#### 介绍
穿越火线简易自动开火压枪脚本，拥有红名自动开火、鼠标连点、跳蹲等功能
...
3.  按下“~”键开启、关闭脚本自瞄动开火部分，按1或2或6或J或L切换模式，按3暂停运行脚本
...
* 缺点：无法检测极远处和用户名为空白的敌人，或者在游戏偶然不显示红名的情况下无法正常运行；压枪方面未适配具体枪械；分辨率和灵敏值未满足要求的需要更改代码中的数值自行适配；自动开火部分切换模式时可能暂时无法切换，未知原因，但可以通过按下“3”或“4”过渡来切换模式
