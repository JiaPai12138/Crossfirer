...
* 自瞄反应较快(其中标准自瞄在i5-10300h+GTX-1660Ti下不开效果展示反应速度为0.08秒以下，快速自瞄为0.04秒以下)
...
* 各功能运行时互相无阻碍(因为"多进程"了嘛(当然在CPU总体占用高的情况下脚本反应速度会相对变慢)...在学习测试AHK_H版本的多线程怎么写，以及希望v2版本出多线程)
