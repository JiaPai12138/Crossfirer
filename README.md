...
3.  ~~以管理员模式运行脚本或者右键选择“Run with UI Access”~~ ~~直接双击，按提示选择管理员或者UI Access~~ 直接打开Crossfirer_v2.x文件夹中的bat文件然后选择你想打开的功能再运行游戏![image](PDF_Images/直接打开bat.png)![image](PDF_Images/选择脚本.png)或者打开发行版里的双击我启动助手!!!.exe![image](PDF_Images/发行版所有文件.png)
...
7.  任何时候先后按下“W”、“F”可进行基本鬼跳；先后按下“W”、“Alt”可进行空中跳蹲；先后按下“S”、“F”可进行跳蹲上墙，先后按下“W”、“C”可进行向前跳跳蹲上箱子，先后按下“S”、“C”可进行ESC跳上箱子，先后按下“Z”、“C”可进行六级跳箱(有位置限制)，先后按下“Z”、“X”可进行前后滑步
8.  按下"-"键重新加载脚本
9.  按下"="键打开关闭秒变猎手功能，游戏界面准星下方有颜色提示
10. 先后按下"C"和"4"键打开C4计时功能~~(期间移动客户端位置会暂时失效)~~，先后按下"C"和"5"或直接按"="取消C4计时功能
11. 按下"H"键可运行一键断网功能，请先运行360流量防火墙或者Netlimiter4，断网时间国服最大8秒西方服最大6秒，断网时与恢复网络时建议保持游戏角色不动
